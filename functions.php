 ...
 */
function rarelyneeded_fonts_url() {
	$fonts_url = '';
	 ...
	 */
	$notoserif = esc_html_x( 'on', 'Noto Serif font: on or off', 'rarelyneeded' );
...
function rarelyneeded_scripts() {
	...
	wp_enqueue_script( 'rarelyneeded-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
